...
public final class GGroup extends GAbstractControl {
	...
	/**
	 * Set the transparency of this group of controls and make it unavailable
	 * to mouse and keyboard events if below the threshold. Child controls 
	 * are ignored? <br>
	 * 
	...
	/**
	 * Set the transparency of this group of controls and make them unavailable
	 * to mouse and keyboard events if below the threshold. Child controls 
	 * are ignored? <br>
