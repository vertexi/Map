...
nnoremap & :&&
nnoremap ,l :call AL()
nnoremap ,w :call WordCount()
nnoremap ,v :Typora
nnoremap ,b :call Togglexxd()
nnoremap ,n :NERDTreeToggle
nnoremap ,c :cd %:p:h
nnoremap ,s :call MakeMySession()
...
noremap <SNR>31_Operator :call slime#store_curpos():set opfunc=slime#send_opg@
map <C-P> <Plug>(ctrlp)
...
set backupext=@2021-05-24.16:13
set completeopt=preview,menuone
set cpoptions=aAceFsB
set dictionary=~/configs/words/words
set expandtab
...
silent only
silent tabonly
cd /mnt/c/Users/Apoptosis/Documents/Processing/Map
...
silent! normal! zE
let s:l = 104 - ((42 * winheight(0) + 23) / 46)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 57 - ((22 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
57
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 57 - ((18 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
57
...
wincmd w
argglobal
if bufexists("Hash.pde") | buffer Hash.pde | else | edit Hash.pde | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 102 - ((21 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
102
...
normal! 0
tabnext
edit data/country_centroids.csv
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
normal! 0
tabnext
edit data/china_countries.geo.json
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
if bufexists("data/countries.geo.json") | buffer data/countries.geo.json | else | edit data/countries.geo.json | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
set stal=1
badd +99 map.pde
badd +1 data/country_centroids.csv
badd +359 file.pde
badd +1 viz.pde
badd +0 util.pde
badd +57 Hash.pde
badd +85 ~/.vimrc
badd +2 JDWP\ exit\ error\ AGENT_ERROR_TRANSPORT_INIT
badd +0 data/countries.geo.json
badd +0 data/china_countries.geo.json
